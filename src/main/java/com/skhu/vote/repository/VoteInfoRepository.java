...
public interface VoteInfoRepository extends JpaRepository<VOTEINFO, Integer> {
	...
	public void update(@Param("voteId") int voteId, @Param("voteName") String voteName, @Param("startTime") Date startTime, @Param("endTime") Date endTime, @Param("target") int target);
